...
Cohesion: 0.06
Nodes (34): Active learning, self-training, and review, CLI Command Catalog (existing repo commands), code:yaml (---), code:bash (uv run python scripts/active_learning.py --db data/swedish_p), code:bash (uv run python scripts/generate_figures.py --db data/swedish_), code:bash (python scripts/export_tables_to_parquet.py --db data/swedish), code:bash (python3 scripts/lookup_speeches.py --speech-id <id> --out lo), code:bash (uv run pytest -q) (+26 more)
...
Cohesion: 0.08
Nodes (25): "0.94 accuracy on held-out speech gold labels", 1. Quick Environment Setup, 2. Full Reproduction Command, 3. Key Artifacts and Their Provenance, 4. How to Verify a Specific Claim, 5. Common Reviewer Questions, 5. Resume and Crash Safety, 6. What to Skip (+17 more)
...
Cohesion: 0.10
Nodes (21): speeches, skipped, skipped, skipped, skipped, skipped, ok, returncode (+13 more)
...
Cohesion: 0.11
Nodes (19): interactive, party_profiles, party_profiles_advanced, ok, returncode, stderr_preview, stdout_preview, step (+11 more)
...
Cohesion: 0.12
Nodes (16): checked, new, anforande, bet, mot, prop, votering, checked (+8 more)

### Community 116 - "Community 116"
Cohesion: 0.12
Nodes (16): skipped, skipped, skipped, dry_run, note, skipped, skipped, skipped (+8 more)
...
Cohesion: 0.20
Nodes (9): Deliverables, Dynamic Structure (optional phase 2), Identification and Constraints, Latent Variable Model Specification (Party Ideology), Link-Confidence Integration, Measurement Frame, Practical Sequencing in This Repo, Purpose (+1 more)
...
Cohesion: 0.31
Nodes (9): _clean_df(), extract_all(), main(), _norm_party(), _parse_party_from_intressent(), _parse_party_from_undertitel(), Extract party from the intressent (speaker/author) list., Fallback: parse party from subtitle like 'av Rebecka Le Moine m.fl. (MP)'. (+1 more)
...
Cohesion: 0.22
Nodes (9): checked, new, stale, anforande, votering, api_check, checked, new (+1 more)

### Community 206 - "Community 206"
Cohesion: 0.28
Nodes (8): _detect_turn_type(), _extract_interpellation_pairs(), extract_interpellations(), _extract_party_from_speaker(), main(), Classify a turn as question, answer, or followup., Extract party code from speaker field like 'Andersson (S)'., Extract ip debate pairs from speeches DataFrame.      The speech parquet has col
...
Cohesion: 0.31
Nodes (7): compute_pareto_frontier(), _compute_recency_weight(), main(), plot_pareto_frontier(), Exponential recency weight: more recent years get higher weight., Compute Pareto frontier: points not dominated on either axis.          A point i, Generate Pareto frontier visualization.          Args:         analysis_dir: Dir
...
Cohesion: 0.25
Nodes (8): ok, returncode, stderr_preview, stdout_preview, step, betankande, dry_run, download
...
Cohesion: 0.32
Nodes (7): _compute_speech_vs_action_gap(), _compute_topic_level_gap(), main(), plot_quid_ergo(), Compute topic-level emphasis of speech vs action, per party.      Returns a per, Generate Quid Ergo visualization.      Two-panel visualization:     1. Party-lev, Compute weighted ideology index for speech-side vs action-side evidence.      Us
...
Cohesion: 0.29
Nodes (6): results, summary, mean_js, mean_mse, n, top1_accuracy
...
Cohesion: 0.33
Nodes (5): Utilities for writing reproducibility provenance records., Write a JSON provenance record for one script run.      The record is written in, write_run_provenance(), test_write_run_provenance_creates_timestamped_record(), test_write_run_provenance_handles_empty_metadata()
...
Cohesion: 0.57
Nodes (6): _load_plot_pareto_module(), _make_party_year_df(), Tests for the Pareto frontier visualization., test_compute_pareto_frontier_returns_nondominated_points(), test_plot_pareto_frontier_handles_min_year_filter(), test_plot_pareto_frontier_writes_figure()

### Community 310 - "Community 310"
Cohesion: 0.52
Nodes (6): _load_render_module(), test_latest_figures_block_uses_image_captions(), test_promise_fulfillment_example_filters_unknown(), test_render_sections_injects_frontmatter_when_source_missing(), test_rendered_sections_have_no_unresolved_template_markers(), test_renderer_exclusion_policy_matches_overlay_policy()

### Community 311 - "Community 311"
Cohesion: 0.33
Nodes (6): Agents, Far Left and Far Right Full Speeches, Pipeline Update 20260614T143528Z, Pipeline Update 20260614T143812Z, Pipeline Update 20260620T180253Z, Pipeline Update 20260629T181738Z
...
Cohesion: 0.33
Nodes (6): speeches, ok, returncode, stderr_preview, stdout_preview, step
...
Cohesion: 0.60
Nodes (5): _load_module(), test_find_matching_doi_prefers_tag_or_repo_indicators(), test_update_checklist_text_marks_doi_complete(), test_update_data_availability_inserts_line_when_missing(), test_update_data_availability_replaces_existing_line()
...
Cohesion: 0.50
Nodes (3): Generated visualizations (manuscript figures), Other artifact directories that support these plots, Pipeline log: 2026-06-28T16:11:16Z
...
Cohesion: 0.67
Nodes (3): CI Workflow, Release Workflow, UV CLI Tool
