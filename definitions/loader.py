...
-----
From code:
    from definitions.loader import load_verified_definitions
    categories = load_verified_definitions()   # raises if checksum mismatch

CLI — verify current file:
    python -m definitions.loader --verify

CLI — update checksum after intentional edit:
    python -m definitions.loader --recheck
"""
